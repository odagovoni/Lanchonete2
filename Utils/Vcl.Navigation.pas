...
type
  TNavigation = class
    ...
    public
      ...
      class procedure Open(FrmClass: TFormClass; Frm: TForm; Parent: TPanel = nil);
      class procedure OpenModal(FrmClass: TFormClass; Frm: TForm; Parent: TForm = nil);
      class procedure Close(Frm: TForm);
    end;

implementation

class procedure TNavigation.Open(FrmClass: TFormClass; Frm: TForm; Parent: TPanel);
begin
